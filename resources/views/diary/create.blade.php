...
<div class="row justify-content-center">
	<form class="form-signin col-lg-10 col-md-12 col-sm-12 " @if($user->getCurrentRol()->name=="admin") action="{{route("admin_diaries_create")}}" @elseif($user->getCurrentRol()->name=="presidente") action="{{route("presidente_diaries_create")}}" @else action="{{route("adjunto_diaries_create")}}" @endif method="post" enctype="multipart/form-data">
        @if($errors->any())
