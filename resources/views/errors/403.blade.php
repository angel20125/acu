...
@section('content')
	<div class="card ">
		...
		<h5 class="text-white"><i class="fas fa-exclamation-triangle mrr"></i>¡Acceso no autorizado!</h5>
		
		</div>
		<div class="card-body">
			<h4 class="font-weight-normal">¡No tienes acceso a esta sección de la plataforma!</h4>
